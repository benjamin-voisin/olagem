...
olagem: main.c terminal_printer.o screen_tools.o endscreen.o startscreen.o
	gcc -g -o olagem -llua -lncursesw main.c terminal_printer.o screen_tools.o endscreen.o startscreen.o
